...
class UserControllerTest {
    ...
    void updateEmail_shouldReturnTokenAndUser() {
        ...
        ResponseEntity<?> response = userController.updateEmail("Bearer token", Map.of(
        ...
        assertSame(saved, body.get("user"));
    }
    ...
    void updatePassword_shouldReturnMessage() {
        User user = mockCurrentUser();
        ResponseEntity<?> response = userController.updatePassword("Bearer token", Map.of(
